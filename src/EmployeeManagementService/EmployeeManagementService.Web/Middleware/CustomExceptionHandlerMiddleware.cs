...
public class CustomExceptionHandlerMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            _logger.LogInformation(identityException, "Identity error: {Errors}", string.Join("; ", identityException.Errors));
            await MapResponse(context, ErrorCodes.IdentityError, messages: identityException.Errors);
        }
    ...
    private static HttpStatusCode ToHttpStatusCode(ErrorCodes errorCode) =>
        errorCode switch
        {
            ...
            ErrorCodes.DuplicateKeyError or
            ErrorCodes.IdentityError => HttpStatusCode.BadRequest,
