...
namespace BankingOperationsService.Infrastructure.Persistence;

public class BankingOperationsServiceDbContext : DbContext, IBankingOperationsServiceDbContext
{
    ...
    public BankingOperationsServiceDbContext(DbContextOptions<BankingOperationsServiceDbContext> options)
        : base(options)
    {
    }

    public BankingOperationsServiceDbContext(
        DbContextOptions<BankingOperationsServiceDbContext> options,
